        ...
        <div className='ml-40 w-1/2 h-screen flex items-center'>
          ...
          <div className='mt-16'>
            ...
            <div className='inpbox border w-full '>
              ...
              <input placeholder='Re-enter Password' className='' type="password" />
            </div>
          </div>
          <div className='mt-10 flex justify-start'>
            <Button onClick={handleClick} className='w-20 h-10 mr-10 text-blue-600'>Login</Button>
            <Button className='w-20 h-10 bg-blue-600 text-white' >Sign Up</Button>
          </div>
          </div>
        </div>
